...
export const makeClosureEnv = (
  params: VarDecl[],
  body: CExp[],
  env: Env
): Closure => ({ tag: "Closure", params: params, body: body, env: env });
...
export const makeClassEnv = (
  fields: VarDecl[],
  methods: Binding[],
  env: Env
): Class => ({ tag: "Class", fields: fields, methods: methods, env: env });
...
export const makeObject = (clas: Class, arg: Value[]): Object => ({
  tag: "Object",
  class: clas,
  args: arg,
  env: makeEmptyEnv(),
});
export const makeObjectEnv = (clas: Class, arg: Value[], env: Env): Object => ({
  tag: "Object",
  class: clas,
  args: arg,
  env: env,
